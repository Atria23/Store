...
//     Route::get('/products', [PriceListController::class, 'showAllProducts'])->name('products.all');
//     Route::get('/products/pulsa', [PriceListController::class, 'showPulsaProducts'])->name('products.pulsa');
...
Route::post('/transaction/initiate', [UserTransactionController::class, 'handleTransaction']);

// Route untuk proses transaksi melalui Digiflazz
Route::post('/transaction/process', [StoreTransactionController::class, 'makeTransaction']);
