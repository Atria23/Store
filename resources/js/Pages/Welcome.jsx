                ...
                <div className="bg-neutralwhite w-full max-w-[500px] relative">
                    <header className="flex items-center justify-between flex-wrap p-6 bg-neutralsilver">
                        ...
                        <div className="flex items-center gap-6">
                            <Link
                                href={route('login')}
                                className="px-5 py-[15px] rounded-lg border border-[#2c2c5b] text-[#2c2c5b] text-[12px] font-[800]"
                            >
                                Log in
                            </Link>
                            <Link
                                href={route('register')}
                                className="px-5 py-[15px] rounded-lg bg-[#2c2c5b] text-white text-[12px] font-[800]"
                            >
                                Register
                            </Link>
                        </div>
                        ...
                        <div className="flex flex-col w-full items-center gap-5 px-[30px] py-12 bg-[#F5F7FA]">
                            <div className="flex flex-wrap justify-center gap-[36.31px_36.31px] w-full rounded-[12.1px]">
                                {statsData.map((stat, index) => (
                                    <div
                                        key={index}
                                        className="w-[147.72px] max-w-none h-[63px] relative"
                                    >
                                        <div className="absolute top-0 left-0 right-0 text-center font-extrabold text-main text-[36.3px] leading-[39.3px] whitespace-nowrap">
                                            {stat.value}
                                        </div>

                                        <div className="absolute w-full top-9 left-0 right-0 font-semibold text-[#6d6d6d] text-lg text-center leading-[18.2px]">
                                            {stat.label}
                                        </div>
                                    </div>
                                ))}
                    ...
                    <section className="w-full">
                        <div className="flex flex-col w-full items-center gap-5 px-[30px] py-12 bg-neutralwhite">
                            ...
                            <Link
                                href={route('register')}
                                className="w-full max-w-[180px] px-6 py-2.5 bg-main rounded-xl text-center font-semibold text-white text-sm"
                            >
                                Gabung Sekarang
                            </Link>
                        </div>
