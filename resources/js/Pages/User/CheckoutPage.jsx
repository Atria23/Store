...
//                 <p className={`text-lg font-bold ${balance < totalBayar ? "text-red-500" : "text-green-600"}`}>
...
//             <div className="mt-4">
//                 <label className="block font-semibold">Masukkan Password:</label>
//                 <input
//                     type="password"
//                     value={password}
...
//                     disabled={balance < totalBayar || loading}
...
//                     }`}
//                 >
//                     {loading ? "Memproses..." : balance < totalBayar ? "Saldo Tidak Cukup" : "Bayar Sekarang"}
//                 </button>
//             </div>
//         </div>
//     );
    ...
    return (
        <div className="p-4">
            ...
            <button
                    ...
                    className="w-full px-4 py-2 rounded text-white bg-green-500 hover:bg-green-600"
                >
                    Bayar Sekarang
                </button>
                </div>
