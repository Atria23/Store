...
const tutorials = {
  shopeepay: [
    { src: '/storage/payment_method/tutorial/shopeepay/1.jpg', title: 'Buka Shopee', desc: 'Masuk ke menu ShopeePay.' },
    { src: '/storage/payment_method/tutorial/shopeepay/2.jpg', title: 'Transfer ke Bank', desc: 'Pilih bank dan masukkan virtual account.' },
    { src: '/storage/payment_method/tutorial/shopeepay/3.jpg', title: 'Konfirmasi', desc: 'Periksa nama dan nominal lalu kirim.' },
  ],
  dana: [
    { src: "/storage/payment_method/tutorial/dana/1.jpg", title: 'Buka DANA', desc: 'Login dan buka menu Kirim.' },
    { src: '/storage/payment_method/tutorial/dana/2.jpg', title: 'Scan QR', desc: 'Gunakan fitur Scan atau masukkan kode QR.' },
  ],
  qris_otomatis: [
