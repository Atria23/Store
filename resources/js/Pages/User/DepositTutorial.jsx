...
const tutorials = {
  qris_otomatis: [
    ...
    { src: '/storage/payment_method/tutorial/qris_otomatis/6.jpg', title: 'Perhatikan Nominal Bayar & Batas Bayar', desc: 'Pembayaran harus senilai total bayar yang tertera dan pastikan belum melewati batas bayar.' },
  ...
  qris_ovo: [
    ...
    { src: '/storage/payment_method/tutorial/qris_ovo/6.jpg', title: 'Perhatikan Nominal Bayar & Batas Bayar', desc: 'Pembayaran harus senilai total bayar yang tertera dan pastikan belum melewati batas bayar.' },
  ...
  qris_dana: [
    ...
    { src: '/storage/payment_method/tutorial/qris_dana/6.jpg', title: 'Perhatikan Nominal Bayar & Batas Bayar', desc: 'Pembayaran harus senilai total bayar yang tertera dan pastikan belum melewati batas bayar.' },
  ...
  qris_gopay: [
    ...
    { src: '/storage/payment_method/tutorial/qris_gopay/6.jpg', title: 'Perhatikan Nominal Bayar & Batas Bayar', desc: 'Pembayaran harus senilai total bayar yang tertera dan pastikan belum melewati batas bayar.' },
  ...
  shopeepay: [
    { src: '/storage/payment_method/tutorial/shopeepay/1.jpg', title: 'Akses Menu Deposit', desc: 'Akses menu deposit melalui beranda.' },
    { src: '/storage/payment_method/tutorial/shopeepay/2.jpg', title: 'Masukkan Nominal & Pilih Shopeepay', desc: 'Minimal menginput nominal 1.000 dan memilih metode pembayaran shopeepay.' },
    { src: '/storage/payment_method/tutorial/shopeepay/3.jpg', title: 'Ajukan Deposit', desc: 'Klik tombol ajukan deposit.' },
    { src: '/storage/payment_method/tutorial/shopeepay/4.jpg', title: 'Pilih Riwayat Deposit', desc: 'Memilih riwayat deposit yang baru dibuat.' },
    { src: '/storage/payment_method/tutorial/shopeepay/5.jpg', title: 'Perhatikan Nominal Bayar & Batas Bayar', desc: 'Klik ikon salin pada total bayar dan pastikan belum melewati batas wakyu pembayaran.' },
    { src: '/storage/payment_method/tutorial/shopeepay/6.jpg', title: 'Salin Nomor Rekening', desc: 'Salin nomor rekening yang tertera, dan buka aplikasi shopeepay' },
    { src: '/storage/payment_method/tutorial/shopeepay/7.jpg', title: 'Bayar Sesuai Total Bayar', desc: 'Lakukan pembayaran senilai total bayar yang tertera pada halaman detail pembayaran.' },
    { src: '/storage/payment_method/tutorial/shopeepay/8.jpg', title: 'Klik Unggah Bukti Pembayaran', desc: 'Kembali ke halaman detail pembayaran, kemudian klik tombol unggah bukti pembayaran.' },
    { src: '/storage/payment_method/tutorial/shopeepay/9.jpg', title: 'Status Menjadi Confirmed', desc: 'Tunggu hingga bukti dikonfirmasi oleh admin, dan pastikan status deposit berubah menjadi confirmed.' },
    { src: '/storage/payment_method/tutorial/shopeepay/10.jpg', title: 'Saldo Masuk', desc: 'Saldo DompetMu (Dompet Muvausa) bertambah sesuai total saldo masuk yang tertera pada halaman detail pembayaran.' },
  ],
  dana: [
    { src: '/storage/payment_method/tutorial/dana/1.jpg', title: 'Akses Menu Deposit', desc: 'Akses menu deposit melalui beranda.' },
    { src: '/storage/payment_method/tutorial/dana/2.jpg', title: 'Masukkan Nominal & Pilih Dana', desc: 'Minimal menginput nominal 1.000 dan memilih metode pembayaran Dana.' },
    { src: '/storage/payment_method/tutorial/dana/3.jpg', title: 'Ajukan Deposit', desc: 'Klik tombol ajukan deposit.' },
    { src: '/storage/payment_method/tutorial/dana/4.jpg', title: 'Pilih Riwayat Deposit', desc: 'Memilih riwayat deposit yang baru dibuat.' },
    { src: '/storage/payment_method/tutorial/dana/5.jpg', title: 'Perhatikan Nominal Bayar & Batas Bayar', desc: 'Klik ikon salin pada total bayar dan pastikan belum melewati batas wakyu pembayaran.' },
    { src: '/storage/payment_method/tutorial/dana/6.jpg', title: 'Salin Nomor Rekening', desc: 'Salin nomor rekening yang tertera, dan buka aplikasi Dana' },
    { src: '/storage/payment_method/tutorial/dana/7.jpg', title: 'Bayar Sesuai Total Bayar', desc: 'Lakukan pembayaran senilai total bayar yang tertera pada halaman detail pembayaran.' },
    { src: '/storage/payment_method/tutorial/dana/8.jpg', title: 'Klik Unggah Bukti Pembayaran', desc: 'Kembali ke halaman detail pembayaran, kemudian klik tombol unggah bukti pembayaran.' },
    { src: '/storage/payment_method/tutorial/dana/9.jpg', title: 'Status Menjadi Confirmed', desc: 'Tunggu hingga bukti dikonfirmasi oleh admin, dan pastikan status deposit berubah menjadi confirmed.' },
    { src: '/storage/payment_method/tutorial/dana/10.jpg', title: 'Saldo Masuk', desc: 'Saldo DompetMu (Dompet Muvausa) bertambah sesuai total saldo masuk yang tertera pada halaman detail pembayaran.' },
  ],
  gopay: [
    { src: '/storage/payment_method/tutorial/gopay/1.jpg', title: 'Akses Menu Deposit', desc: 'Akses menu deposit melalui beranda.' },
    { src: '/storage/payment_method/tutorial/gopay/2.jpg', title: 'Masukkan Nominal & Pilih Gopay', desc: 'Minimal menginput nominal 1.000 dan memilih metode pembayaran Gopay.' },
    { src: '/storage/payment_method/tutorial/gopay/3.jpg', title: 'Ajukan Deposit', desc: 'Klik tombol ajukan deposit.' },
    { src: '/storage/payment_method/tutorial/gopay/4.jpg', title: 'Pilih Riwayat Deposit', desc: 'Memilih riwayat deposit yang baru dibuat.' },
    { src: '/storage/payment_method/tutorial/gopay/5.jpg', title: 'Perhatikan Nominal Bayar & Batas Bayar', desc: 'Klik ikon salin pada total bayar dan pastikan belum melewati batas wakyu pembayaran.' },
    { src: '/storage/payment_method/tutorial/gopay/6.jpg', title: 'Salin Nomor Rekening', desc: 'Salin nomor rekening yang tertera, dan buka aplikasi Gopay' },
    { src: '/storage/payment_method/tutorial/gopay/7.jpg', title: 'Bayar Sesuai Total Bayar', desc: 'Lakukan pembayaran senilai total bayar yang tertera pada halaman detail pembayaran.' },
    { src: '/storage/payment_method/tutorial/gopay/8.jpg', title: 'Klik Unggah Bukti Pembayaran', desc: 'Kembali ke halaman detail pembayaran, kemudian klik tombol unggah bukti pembayaran.' },
    { src: '/storage/payment_method/tutorial/gopay/9.jpg', title: 'Status Menjadi Confirmed', desc: 'Tunggu hingga bukti dikonfirmasi oleh admin, dan pastikan status deposit berubah menjadi confirmed.' },
    { src: '/storage/payment_method/tutorial/gopay/10.jpg', title: 'Saldo Masuk', desc: 'Saldo DompetMu (Dompet Muvausa) bertambah sesuai total saldo masuk yang tertera pada halaman detail pembayaran.' },
  ],
  ovo: [
    { src: '/storage/payment_method/tutorial/ovo/1.jpg', title: 'Akses Menu Deposit', desc: 'Akses menu deposit melalui beranda.' },
    { src: '/storage/payment_method/tutorial/ovo/2.jpg', title: 'Masukkan Nominal & Pilih Ovo', desc: 'Minimal menginput nominal 1.000 dan memilih metode pembayaran Ovo.' },
    { src: '/storage/payment_method/tutorial/ovo/3.jpg', title: 'Ajukan Deposit', desc: 'Klik tombol ajukan deposit.' },
    { src: '/storage/payment_method/tutorial/ovo/4.jpg', title: 'Pilih Riwayat Deposit', desc: 'Memilih riwayat deposit yang baru dibuat.' },
    { src: '/storage/payment_method/tutorial/ovo/5.jpg', title: 'Perhatikan Nominal Bayar & Batas Bayar', desc: 'Klik ikon salin pada total bayar dan pastikan belum melewati batas wakyu pembayaran.' },
    { src: '/storage/payment_method/tutorial/ovo/6.jpg', title: 'Salin Nomor Rekening', desc: 'Salin nomor rekening yang tertera, dan buka aplikasi Ovo' },
    { src: '/storage/payment_method/tutorial/ovo/7.jpg', title: 'Bayar Sesuai Total Bayar', desc: 'Lakukan pembayaran senilai total bayar yang tertera pada halaman detail pembayaran.' },
    { src: '/storage/payment_method/tutorial/ovo/8.jpg', title: 'Klik Unggah Bukti Pembayaran', desc: 'Kembali ke halaman detail pembayaran, kemudian klik tombol unggah bukti pembayaran.' },
    { src: '/storage/payment_method/tutorial/ovo/9.jpg', title: 'Status Menjadi Confirmed', desc: 'Tunggu hingga bukti dikonfirmasi oleh admin, dan pastikan status deposit berubah menjadi confirmed.' },
    { src: '/storage/payment_method/tutorial/ovo/10.jpg', title: 'Saldo Masuk', desc: 'Saldo DompetMu (Dompet Muvausa) bertambah sesuai total saldo masuk yang tertera pada halaman detail pembayaran.' },
  ],
};
