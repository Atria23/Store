                        ...
                        <div className="w-full flex flex-col space-y-2 items-start justify-center">
                            ...
                            <div className="w-full flex flex-row justify-between items-center">
                                ...
                                <span className="text-md font-utama font-semibold text-black">
                                    {
                                        formatRupiah(
                                            Number(price) + Number(adminFee)
                                            || Number(String(transaction.price).replace(/\D/g, "")) + Number(String(transaction.admin_fee).replace(/\D/g, ""))
                                        )
                                    }
                                </span>
                            </div>
                    ...
                    <div className="w-full w-max-[500px] p-4">
                        ...
                        <a href={route('store.edit')}>
                            ...
                            <div className="flex justify-between mb-4">
                                ...
                                <button className="w-[100%] border border-blue-500 text-blue-500 rounded-lg px-4 py-3 text-sm text-center flex items-center justify-center gap-2">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor"
