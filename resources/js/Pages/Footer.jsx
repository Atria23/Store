...
//   return (
//     <footer className="fixed bottom-0 left-0 right-0 bg-white shadow-lg p-3 z-50">
//       <div className="flex justify-between items-center text-sm">
//         {navItems.map((item, index) => (
//           <a
//             key={index}
//             href={item.path}
//             className={`flex flex-col items-center justify-center flex-grow transition ${location.pathname === item.path
//                 ? "text-blue-500 font-semibold" // Gaya elemen aktif
...
function Footer() {
  const { post } = useForm(); // Digunakan untuk melakukan post request ke route logout

  const handleLogout = () => {
    post("/logout"); // Arahkan ke route logout
  };
