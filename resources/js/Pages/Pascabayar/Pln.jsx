...
//     const [inquiryResult, setInquiryResult] = useState(null); // Akan menyimpan objek inquiry LENGKAP
...
//             // response.json() akan mem-parsing SELURUH body response dari JSON
//             const data = await response.json(); 
            
//             if (!response.ok) throw new Error(data.message || 'Gagal melakukan pengecekan tagihan.');
            
//             // Menyimpan SELURUH objek 'data' ke dalam state.
//             // Sekarang, inquiryResult berisi semua field: ref_id, customer_name, desc, dll.
...
//         // Validasi saldo menggunakan selling_price
...
//         try {
//             // Sebaiknya Anda membuat route ini untuk keamanan
...
//                                 <button onClick={() => window.location.reload()} className="w-full py-2 px-4 bg-main text-white font-semibold rounded-lg hover:bg-blue-700">
//                                     Transaksi Lagi
//                                 </button>
//                             </div>
//                         ) : inquiryResult ? (
//                             // Tampilan Detail Tagihan (Menampilkan lebih banyak data)
...
//                                     {/* Tampilkan denda hanya jika nilainya lebih dari 0 */}
// {Number(inquiryResult.desc.detail[0]?.denda) > 0 && (
//     <div className="flex justify-between">
//         <span className="text-gray-500">Denda</span>
//         <span className="font-medium">{formatRupiah(inquiryResult.desc.detail[0]?.denda)}</span>
//     </div>
// )}
//                                 </div>
//                                 <div className="w-full h-px bg-gray-200" />
...
//                                     {/* PERBAIKAN: Menggunakan selling_price agar sesuai dengan backend */}
...
//                 {/* Modal Konfirmasi Password (Tidak ada perubahan di sini) */}
//                 {isModalOpen && (
...
// // --- AWAL: DUMMY DATA UNTUK DEVELOPMENT ---
// // Objek ini meniru respons SUKSES yang lengkap dari API pembayaran.
// // Gunakan ini untuk men-style tampilan struk tanpa harus melakukan transaksi.
// const dummyPaymentResultSuccess = {
//   status: 'Sukses',
//   message: 'PEMBAYARAN PLN PASCABAYAR SUKSES.',
//   selling_price: 11000,
//   customer_name: 'DUMMY PELANGGAN',
//   customer_no: '530001234567',
//   desc: {
//     tarif: 'R1',
//     daya: 1300,
//     detail: [
...
//         periode: '202508',
//         meter_awal: '00123400',
//         meter_akhir: '00124500',
//         nilai_tagihan: '8000',
//         denda: '500',
//       }
//     ]
//   },
//   sn: 'DUMMYSN-FOR-STYLING-12345',
// };
// // --- AKHIR: DUMMY DATA ---
...
//     // --- PENGATURAN MODE DEVELOPER / PRODUKSI ---
//     // Mode Developer: Langsung tampilkan struk sukses dengan data dummy.
//     const [paymentResult, setPaymentResult] = useState(dummyPaymentResultSuccess);
//     // Mode Produksi: Mulai dari awal (form input). Aktifkan baris ini dan nonaktifkan baris di atas.
//     // const [paymentResult, setPaymentResult] = useState(null);
...
//     // Langkah 1: Cek Tagihan (LOGIKA ASLI TETAP ADA)
//     const handleInquiry = async (e) => {
//         e.preventDefault();
//         setIsLoading(true);
//         setError('');
...
//     // Langkah 2: Buka Modal Konfirmasi (LOGIKA ASLI TETAP ADA)
//     const handleBayarClick = () => {
//         if (userBalance < inquiryResult.selling_price) {
//             setError("Saldo tidak mencukupi untuk melakukan transaksi.");
//             return;
...
//     // Langkah 3: Kirim Transaksi setelah Konfirmasi Password (LOGIKA ASLI TETAP ADA)
//     const handleSubmitPayment = async (e) => {
//         e.preventDefault();
//         if (!password) {
//             setError("Silakan masukkan password untuk melanjutkan.");
...
//                             ) : (
//                                 <div className="space-y-4 text-center">
//                                     <h3 className="font-bold text-lg text-red-600">Transaksi Gagal</h3>
//                                     <p className="text-sm text-gray-600">{paymentResult.message}</p>
//                                     <button onClick={() => setPaymentResult(null)} className="w-full py-2 px-4 bg-main text-white font-semibold rounded-lg hover:bg-blue-700">
//                                         Coba Lagi
//                                     </button>
