              ...
              >
                ...
                <div className="flex flex-col space-y-1 items-end justify-center w-full">
                  ...
                  <a
                    ...
                    disabled={!d.proof_of_payment}
                    className={`text-xs rounded 
                                ${d.proof_of_payment ? "text-blue-600" : "text-gray-400 cursor-not-allowed"} 
                                hover:bg-gray-100 transition disabled:hover:bg-transparent`
                    }
                  >
                    Lihat Bukti
                  </a>
