...
//                       maxLength={6}
//                       required
//                       className="bg-transparent text-sm border-none w-full focus:ring-0 focus:outline-none placeholder-gray-400 px-3"
//                     />
//                   </div>
...
//                 <button
//                   type="submit"
//                   className="w-full text-white p-2 rounded text-sm bg-main hover:bg-blue-700 transition"
//                 >
//                   Verifikasi Kode OTP
//                 </button>
...
//                   type="button"
//                   onClick={resendOtp}
//                   className="w-full text-main border border-main p-2 rounded text-sm bg-white hover:bg-neutral-100 transition"
//                 >
