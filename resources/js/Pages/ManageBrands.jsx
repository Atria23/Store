    ...
    useEffect(() => {
        const handleClickOutsideCategory = (e) => {
            if (categoryRef.current && !categoryRef.current.contains(e.target)) {
                ...
                if (selectedCategory) {
                    setCategorySearch(selectedCategory.name); // restore sebelumnya
                }
            }
        };
                                    ...
                                    <div className="w-full flex flex-row items-center justify-between">
                                        ...
                                        <div className="w-max flex items-center space-x-2 justify-end">
                                            ...
                                            <p className="text-sm text-gray-700">
                                                {selectedIds.length} brand dipilih
                                            </p>
                                        </div>
                    ...
                    <div className="bg-white rounded-lg p-4 max-w-[90%] w-[400px] relative z-50">
                        ...
                        <div className="mb-2 relative" ref={categoryRef}>
                            ...
                            <input
                                ...
                                onFocus={() => {
                                    setCategorySearch(""); // Kosongkan input saat fokus
                                    setShowCategoryOptions(true); // Tampilkan opsi
                                }}
                                onChange={(e) => {
