...
const menuItems = [
  ...
  {
    label: "Deposit Admin",
    href: route("deposit-admin.create"),
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="currentColor" viewBox="0 0 16 16">
  ...
  {
    label: "Riwayat PoinMu",
    href: route("poinmu.manage"),
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="currentColor" viewBox="0 0 16 16">
