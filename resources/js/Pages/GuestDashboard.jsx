...
function GuestDashboard({ user, categories }) {
  ...
  // --- START: Penambahan Kategori Manual untuk GuestDashboard ---
  ...
  const manualCategories = [
    ...
    //     </svg>
    //   ),
    //   // Sesuaikan rute ini jika Anda memiliki halaman khusus untuk Guest yang login
    ...
    // },
    {
      ...
      link: route('pascapln.index'), // Rute ke halaman Tagihan Listrik
    },
    {
      id: 'pdam', // ID unik
      name: 'Air',
      ...
      iconSvg: null, // Untuk kategori ini, kita pakai image, jadi iconSvg null
      link: route('pascapdam.index'), // Rute ke halaman Air
    },
    {
      id: 'bpjs', // ID unik
      name: 'BPJS',
      ...
      iconSvg: null, // Untuk kategori ini, kita pakai image, jadi iconSvg null
      link: route('pascabpjs.index'), // Rute ke halaman BPJS
    },
    {
      id: 'internet', // ID unik
      ...
      iconSvg: null, // Untuk kategori ini, kita pakai image, jadi iconSvg null
      link: route('pascainternet.index'), // Rute ke halaman Tagihan Internet
    },
    {
      id: 'pbb', // ID unik
      name: 'PBB',
  ...
  // --- END: Penambahan Kategori Manual untuk GuestDashboard ---
